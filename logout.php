...
/* Bank Info (for customer context) */
.bank-info {
...
<div class="logout-card">
    ...
    <!-- Bank Info (optional - for customer context) -->
    <div class="bank-info">
        <i class="fas fa-university"></i>
        <span>You have been logged out from bank portal</span>
    </div>
    
    <!-- Timer Container (5 seconds) -->
    <div class="timer-container">
        <div class="timer-text">Redirecting to login in</div>
    ...
    <div class="button-group">
        <a href="banklogin.php" class="btn btn-primary">
