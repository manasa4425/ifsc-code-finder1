...
<head>
<meta charset="UTF-8">
<title>Withdraw Amount | Customer - Bank IFSC Finder</title>
            ...
            <form method="post">
                ...
                <div class="input-group">
                    ...
                    <div class="input-wrapper">
                        <i class="fa fa-money-bill-wave"></i>
                        <input type="number" name="amount" placeholder="Enter amount to withdraw" min="1" max="<?php echo $customer['balance'] ?? 0; ?>" step="0.01" required>
                        <span class="amount-symbol">INR</span>
                    </div>
                    <small style="color: #64748b; display: block; margin-top: 5px;">Maximum withdrawal: ₹<?php echo number_format($customer['balance'] ?? 0, 2); ?></small>
                </div>
            ...
            if($newbal >= 500) {
                ...
                try {
                    ...
                    if($update) {
                        ...
                        mysqli_commit($conn);
                        echo "<script>alert('✅ Withdrawal Successful! ₹" . number_format($amount, 2) . " debited from your account');window.location='cwithdraw.php';</script>";
                    } else {
