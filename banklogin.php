...
if (isset($_POST['login'])) {
    ...
    $sql = "SELECT * FROM bank WHERE name='$bankname' AND password='$password'";
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        $error = "Invalid Bank Name or Password";
    }
}
?>
...
<head>
<meta charset="UTF-8">
<title>Bank Login | Bank IFSC Finder</title>
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="login-header">
                <h2><i class="fa fa-university"></i> Bank Login</h2>
                <p>Authorized bank access only</p>
            </div>
            ...
            <form method="post">
                <div class="input-group">
                    ...
                    <input type="text" name="bankname" placeholder="Bank Name" required autofocus>
                </div>
                ...
                <button class="login-btn" type="submit" name="login">
                    <i class="fas fa-sign-in-alt"></i> Access Bank Dashboard
                </button>
            </form>
...
document.addEventListener('DOMContentLoaded', function() {
    const currentPage = 'banklogin.php';
