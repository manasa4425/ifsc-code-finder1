...
<head>
<meta charset="UTF-8">
<title>Deposit Amount | Bank IFSC Finder</title>
...
/* Amount Display (for when account is fetched) */
.amount-display {
    background: #F8FAFC;
    padding: 15px 20px;
    border-radius: 12px;
...
<div class="main-container">
    ...
    <div class="nav-tabs">
        ...
        <a href="deposite.php" class="tab-link active">
    ...
    <div class="content-card">
        ...
        <div class="page-header">
            ...
            <p>Securely credit money into customer account</p>
        </div>
        ...
        <div class="deposit-card">
            ...
            <div class="balance-preview">
                ...
                <div class="balance-content">
                    ...
                    <span>Enter account number to view and update balance</span>
                </div>
            </div>
            ...
            <form method="post">
                ...
                <div class="input-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="number" name="amount" placeholder="Enter amount to deposit" min="1" step="0.01" required>
                    </div>
                </div>
...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        if ($update) {
            echo "<script>alert('✅ Deposit Successful! ₹" . number_format($amount, 2) . " credited to Account: " . $accno . "');window.location='deposite.php';</script>";
        } else {
